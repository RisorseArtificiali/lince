> Historical acceptance record for the retired mailbox implementation. The terminal conversation design supersedes its groups, task lifecycle and intake requirements. See [current guide](../agent-messaging.md) and [current validation](../agent-messaging-validation.md).
